...
/** BlueBack.PoolList.Editor
*/
#if(UNITY_EDITOR)
namespace BlueBack.PoolList.Editor
{
	/** UpdatePackage
	*/
	public static class UpdatePackage
	{
		...
		*/
		#if(!DEF_USER_BLUEBACK_POOLLIST)
		[UnityEditor.MenuItem("BlueBack/PoolList/UpdatePackage/Develop")]
		#endif
		public static void MenuItem_UpdatePackage_Develop()
		{
			UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmPoolList.git?path=BlueBackPoolList/Assets/UPM");
		}

		/** MenuItem_UpdatePackage_Last
		*/
		#if(!DEF_USER_BLUEBACK_POOLLIST)
		[UnityEditor.MenuItem("BlueBack/PoolList/UpdatePackage/Last " + Version.packageversion)]
		#endif
		public static void MenuItem_UpdatePackage_Last()
		{
			string t_version = GetLastReleaseNameFromGitHub();
			if(t_version != null){
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmPoolList.git?path=BlueBackPoolList/Assets/UPM#" + t_version);
			}
		}
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmPoolList/releases/latest";
